...
print("The float values are ", floats)
...
print("The list contains a row where each letter was repeated three times", letters)
...
print("The lengths of each element are ", lengths)