...
# The wear method should return the string “I'm wearing this fashionable 
# piece of clothing!”
...
# It should define a lose_one instance method that returns the string 
# “Where did my other one go?”
# It should override the wear method to return the string 
# “Take a look at my socks! They're gorgeous!”
# It should override the sell method to return the string 
# “Buy my socks!”
